...
<title>cabBro | Bike Listing</title>
<!--Bootstrap -->
...
$sql = "SELECT id from bikevehicles";
...
<?php $sql = "SELECT bikevehicles.*,bikebrands.BrandName,bikebrands.id as bid  from bikevehicles join bikebrands on bikebrands.id=bikevehicles.VehiclesBrand";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
            ...
            <form action="search-bikeresult.php" method="post">
              <div class="form-group select">
                <select class="form-control" name="brand">
                  ...
                  <?php $sql = "SELECT * from  bikebrands ";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
...
<option value="Petrol">Petrol</option>
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-motorcycle" aria-hidden="true"></i> Recently Listed Bike</h5>
          </div>
          <div class="recent_addedcars">
            <ul>
<?php $sql = "SELECT bikevehicles.*,bikebrands.BrandName,bikebrands.id as bid  from bikevehicles join bikebrands on bikebrands.id=bikevehicles.VehiclesBrand order by id desc limit 4";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
...
{  ?>
              ...
              <li class="gray-bg">
                <div class="recent_post_img"> <a href="bike-details.php?vhid=<?php echo htmlentities($result->id);?>"><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" alt="image"></a> </div>
                <div class="recent_post_title"> <a href="bike-details.php?vhid=<?php echo htmlentities($result->id);?>"><?php echo htmlentities($result->BrandName);?> , <?php echo htmlentities($result->VehiclesTitle);?></a>
